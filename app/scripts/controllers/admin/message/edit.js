...
angular.module('partybotWebApp')
  .controller('AdminMessageEditCtrl', function ($scope, $timeout, Message, filterFilter, $location, $route) {
    ...
    $scope.message = Message.get({messageId: $scope.messageId}, function(message) {
    });

    // watch the message object for changes
